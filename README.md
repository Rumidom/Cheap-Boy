...
) and using the components of the sup 400 in 1 should yield an ultra cheap yet powerful handheld. The sup 400 in 1 has already been [reversed enginered](https://hackaday.io/project/175322-dissecting-a-hand-held-noac-console-sup-400-in-1) to support a custom rom. But as far as I'm aware this is the first attempt at running gameboy games on it. 
